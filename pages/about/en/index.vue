          ...
          <div class="content sm:flex sm:items-center mt-14 lg:px-16">
            ...
            <div class="content-text 2xl:w-3/5">
              ...
              <p class="text-lg sm:text-xl font-normal mt-4">
                My travel with the code starts in 2019 at the university where a friend, for the first time, show me what makes all those website and application we use.
