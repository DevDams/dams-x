  ...
  <div class="w-full h-screen text-left">
    <div class="w-9/12 h-full mx-auto px-0 md:px-6 flex flex-col items-center justify-center">
      <div class="mt-10">
        ...
        <div class="mt-6">
          <nuxt-link to="/about" class="text-xl sm:text-2xl md:text-3xl xl:text-5xl font-medium">
            more...
          </nuxt-link>
        </div>
        <div class="contact-btn text-right mt-10">
          <nuxt-link to="/contacts" class="text-xl sm:text-2xl md:text-3xl xl:text-5xl">
            Contacts
          </nuxt-link>
        </div>
      </div>
