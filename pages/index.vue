        ...
        <div class="home-project-area mt-20">
          <div class="area-1 flex flex-col sm:flex-row">
            ...
            <div class="project-image mt-4 sm:w-2/3 md:w-1/2">
              <img class="md:pr-16" src="~/assets/images/mad_.png" alt="Mad agence website clone capture">
            </div>
          </div>
          <div class="area-2 mt-24 flex flex-col-reverse sm:flex-row">
            <div class="project-image mt-4 sm:w-2/3 md:w-1/2">
              <img class="md:pl-16" src="~/assets/images/pinky_.png" alt="Pinky bloc note app capture">
            </div>
      ...
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Adams Aimé-Désiré, front-end developer. Let\'s wrok together and build awsome stuff'
        }
      ]
    }
  },
...
.home-project-area .area-1 .project-title svg {
  width: 30px;
  height: 30px;
  transform: rotate(180deg);
}

.home-project-area .area-2 .project-title svg {
  width: 30px;
  height: 30px;
  transform: rotate(-90deg);
}
